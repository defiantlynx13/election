                            ...
                            <div class="card-content">
                                <div class="row no-gutters">
                                    <div class="col-lg-8 col-12">
                                        <div class="card-body">
                                            <h4 class="text-primary font-medium-3 text-bold-500 line-height-1 mb-2 primary-font">رای گیری موقتا غیر فعال گردیده است!</h4>
                                            <p>جهت کسب اطلاعات بیشتر با پشتیبانی تماس حاصل فرمایید.</p>
                                            <button type="button" class="btn btn-success glow mr-1 mb-1">
                                                <span class="align-middle ml-25">1051 496 0915</span>

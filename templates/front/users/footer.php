...
<!-- BEGIN: Page JS-->
<script src="<?php echo $dash_assets_url.'/js/scripts/pages/dashboard-ecommerce.js'?>"></script><!-- END: Page JS-->
...
<script src="<?php echo $dash_assets_url.'js/pages/users.js'?>"></script><!-- END: Page JS-->

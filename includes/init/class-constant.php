...
class Constant {
	...
	public static function define_constant() {
        ...
        /**
         * PLUGIN_NAME_TPL constant.
         * It is used to specify vendor urls inside templates directory.
         */
        if ( ! defined( 'PLUGIN_VENDOR' ) ) {
            define( 'PLUGIN_VENDOR', trailingslashit( PLUGIN_NAME_PATH . 'vendor' ) );
        }
        ...
        /**
         * PLUGIN_TEXT_DOMAIN constant.
         * It is used to specify TEXT DOMAIN  in Plugin Strings.
         */
        if ( ! defined( 'PLUGIN_TEXT_DOMAIN' ) ) {
            define( 'PLUGIN_TEXT_DOMAIN', 'TSB' );
        }

        if ( ! defined( 'ELECTION_DB_VERSION' ) ) {

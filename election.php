<?php
/**
 * Plugin Name:      Election
 * Plugin URI:        https://jbyte.ir/projects
 * Description:       This is private plugin please dont share it
 * Version:           1.2.2
 * Author:            Saeed Jamali
...
use Plugin_Name_Dir\Includes\Init\Admin_Hook;
...
class ELECTION {
	...
	private function __construct() {
		...
		register_deactivation_hook(
			__FILE__,
			array( $this, 'deactivate_ELECTION' )
		);
		/**
		 * Register deactivation hook.
		 * Register deactivation hook for this plugin by invoking deactivate_plugin_name
		...
		register_uninstall_hook(
			__FILE__,
			array( 'Plugin_Name_Plugin', 'uninstall_ELECTION' )
		);

        self::run_ELECTION_plugin();
	 ...
	 * @since  1.0.0
	 */
	public static function run_ELECTION_plugin() {
		$plugin = new Core();
		$plugin->run();
	}
	 ...
	 * @since  1.0.0
	 */
	public static function uninstall_ELECTION() {
		Uninstall::uninstall();
	}
	 ...
	 * @since  1.0.0
	 */
	public function deactivate_ELECTION() {

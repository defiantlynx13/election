 ...
 */
class Recover_password_Handler implements Page_Handler {
	...
	public function render() {
        $dash_assets_url=trailingslashit( PLUGIN_NAME_URL ) . 'assets/dashboard-login/';

		Utility::load_template( 'recover-password/recover-password', compact( 'dash_assets_url' ), 'front' );
		exit;
	}
}

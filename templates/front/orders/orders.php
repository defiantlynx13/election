...
if (is_user_logged_in())
{
    ...
    else
    {
        ...
        $dash_assets_url=trailingslashit( PLUGIN_NAME_URL ) . 'assets/dashboard/';
        Utility::load_template( 'orders.head', compact( array('user_type_and_permissions','dash_assets_url','cu_id','user_info')), 'front' );
        Utility::load_template( 'orders.content',compact( array('user_type_and_permissions','dash_assets_url','cu_id','user_info')), 'front' );
        Utility::load_template( 'general.copyright', compact( array('user_type_and_permissions','dash_assets_url','cu_id','user_info')), 'front' );
        Utility::load_template( 'orders.footer', compact( array('user_type_and_permissions','dash_assets_url','cu_id','user_info')), 'front' );
    }

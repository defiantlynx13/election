...
use Plugin_Name_Dir\Includes\PageHandlers\Access_Denied_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\AUTH_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\Confirm_Code_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\NOT_FOUND_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\Orders_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\Panel_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\Recover_password_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\Results_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\Settings_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\users_Handler;
...
class Router {
	...
	private function set_default_routes() {
		$this->routes = [
            '/auth'        => Auth_Handler::class,
            '/confirm_code'        => Confirm_Code_Handler::class,
//            '/recover-password'        => Recover_password_Handler::class,

            '/panel'        => Panel_Handler::class,
            '/results'        => Results_Handler::class,
            '/settings'        => Settings_Handler::class,

			'/not_found'        => NOT_FOUND_Handler::class,
			'/access_denied'        => Access_Denied_Handler::class,
//			'/users'        => Users_Handler::class,
//			'/orders'        => Orders_Handler::class,
		];
	}

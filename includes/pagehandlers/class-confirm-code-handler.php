 ...
 */
class Confirm_Code_Handler implements Page_Handler {
	...
	public function render() {
		...
		Utility::load_template( 'confirm_code/confirm_code', compact( array('dash_assets_url','dash_assets_url2') ), 'front' );
		exit;
	}
}
